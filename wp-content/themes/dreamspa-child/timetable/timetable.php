	...
	foreach($events as $key=>$details)
	{
		...
		$timetable_custom_url = get_post_meta($details["id"], "timetable_custom_url", true);
                ...
                if($curr_lang=="en_GB"){
                    ...
                    if($timetable_custom_url=="/yoga-fuer-anfaenger/")
                        $timetable_custom_url="/en/yoga-for-beginners/";
                    
                    if($timetable_custom_url=="/yoga-fuer-mittelstufe-und-fortgeschrittene/")
                        $timetable_custom_url="/en/intermediate-level/";
                }
                else if($curr_lang=="es_ES"){
                     if($timetable_custom_url=="/yoga-fuer-anfaenger/")
                        $timetable_custom_url="/es/principiantes/";
                      if($timetable_custom_url=="/yoga-fuer-mittelstufe-und-fortgeschrittene/")
                        $timetable_custom_url="/es/intermedio/";
                }
