          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <select name="permissions" onchange="bwg_show_hide_roles();">
                    <?php
                  ...
                  <div class="spider_description">Choose a user type who can add/edit galleries, images, albums and tags.</div>
                </td>
              </tr>
              <tr class="bwg_roles">
                <td class="spider_label_options">
                ...
                <table style="display: inline-table;">
                  <tbody>
                    ...
                    <tr id="tr_addthis_profile_id">
                      <td class="spider_label_options">
                        <label for="addthis_profile_id">AddThis profile id:</label>
                      </td>
                      <td>
                        <input type="text" name="addthis_profile_id" id="addthis_profile_id" value="<?php echo $row->addthis_profile_id; ?>" />
                        <div class="spider_description">Create an account <a target="_blank" href="https://www.addthis.com/register">here</a>.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input id="instagram_client_id" name="instagram_client_id" type="text" style="display:inline-block; width:100%;" value="<?php echo $row->instagram_client_id; ?>" />
                 <div class="spider_description">Enable creating Instagram galleries.</div>
                </td>
              </tr>
            </tbody>
          </table>
                ...
                <table style="width: 100%; display: inline-table;">
                  <tbody>
                    <tr>
                      <td class="spider_label_options"><label>Enable image title: </label></td>
                      <td>
                        <input type="radio" name="carousel_enable_title" id="carousel_enable_title_yes" value="1" <?php if ($row->carousel_enable_title) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('', 'tr_carousel_title_position', 'carousel_enable_title_yes')" /><label for="carousel_enable_title_yes">Yes</label>
                        <input type="radio" name="carousel_enable_title" id="carousel_enable_title_no" value="0" <?php if (!$row->carousel_enable_title) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('none', 'tr_carousel_title_position', 'carousel_enable_title_no')" /><label for="carousel_enable_title_no">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="carousel_enable_autoplay" id="carousel_enable_autoplay_yes" value="1" <?php if ($row->carousel_enable_autoplay) echo 'checked="checked"'; ?> /><label for="carousel_enable_autoplay_yes">Yes</label>
                        <input type="radio" name="carousel_enable_autoplay" id="carousel_enable_autoplay_no" value="0" <?php if (!$row->carousel_enable_autoplay) echo 'checked="checked"'; ?> /><label for="carousel_enable_autoplay_no">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="carousel_fit_containerWidth" id="carousel_fit_containerWidth_yes" value="1" <?php if ($row->carousel_fit_containerWidth) echo 'checked="checked"'; ?> /><label for="carousel_fit_containerWidth_yes">Yes</label>
                        <input type="radio" name="carousel_fit_containerWidth" id="carousel_fit_containerWidth_no" value="0" <?php if (!$row->carousel_fit_containerWidth) echo 'checked="checked"'; ?> /><label for="carousel_fit_containerWidth_no">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr> 
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="carousel_prev_next_butt" id="carousel_prev_next_butt_yes" value="1" <?php if ($row->carousel_prev_next_butt) echo 'checked="checked"'; ?> /><label for="carousel_prev_next_butt_yes">Yes</label>
                        <input type="radio" name="carousel_prev_next_butt" id="carousel_prev_next_butt_no" value="0" <?php if (!$row->carousel_prev_next_butt) echo 'checked="checked"'; ?> /><label for="carousel_prev_next_butt_no">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr> 
                    <tr>
                      ...
                      <td>
                        <input type="radio" name="carousel_play_pause_butt" id="carousel_play_pause_butt_yes" value="1" <?php if ($row->carousel_play_pause_butt) echo 'checked="checked"'; ?> /><label for="carousel_play_pause_butt_yes">Yes</label>
                        <input type="radio" name="carousel_play_pause_butt" id="carousel_play_pause_butt_no" value="0" <?php if (!$row->carousel_play_pause_butt) echo 'checked="checked"'; ?> /><label for="carousel_play_pause_butt_no">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr> 
                  </tbody>
