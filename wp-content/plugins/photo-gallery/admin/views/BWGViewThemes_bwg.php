  ...
  public function edit($id, $reset) {
    ...
    <form class="wrap" method="post" action="admin.php?page=themes_bwg" style="width:99%;">
      ...
      <div style="float: left; margin: 10px 0 0; display: none;" id="type_menu">
        ...
        <div id="type_Carousel" class="theme_type" onclick="bwg_change_theme_type('Carousel')">Carousel</div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td id="mosaic_thumb_transition">
                    ...
                    <label for="mosaic_thumb_transition1" id="mosaic_thumb_transition1_lbl">Yes</label>
                    ...
                    <label for="mosaic_thumb_transition0" id="mosaic_thumb_transition0_lbl">No</label>
                  </td>
                </tr>
                <tr>
         ...
         <fieldset class="spider_type_fieldset" id="Carousel">
          <fieldset class="spider_child_fieldset" id="Carousel_1">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="carousel_cont_bg_color">Background color: </label></td>
                  <td>
                 ...
                 <tr>
                  <td class="spider_label"><label for="carousel_cont_btn_transparent">Container opacity: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_size">Right, left buttons size: </label></td>
                  <td>
                 ...
                 <tr>
                  <td class="spider_label"><label for="carousel_play_pause_btn_size">Play, pause buttons size: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_color">Buttons color: </label></td>
                  <td>
                    <input type="text" name="carousel_rl_btn_color" id="carousel_rl_btn_color" value="<?php echo $row->carousel_rl_btn_color; ?>" class="color"/>
                  </td>
                </tr>
                <tr>
                  <td class="spider_label"><label for="carousel_close_btn_transparent">Buttons transparency: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_close_rl_btn_hover_color">Buttons hover color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_width">Right, left buttons width: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_height">Right, left buttons height: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_bg_color">Right, left buttons background color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_border_width">Right, left buttons border width: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_border_style">Right, left buttons border style: </label></td>
                  <td>
                    <select name="carousel_rl_btn_border_style" id="carousel_rl_btn_border_style">
                      <?php
                      foreach ($border_styles as $key => $border_style) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->carousel_rl_btn_border_style == $key) ? 'selected="selected"' : ''); ?>><?php echo $border_style; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_border_color">Right, left buttons border color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_border_radius">Right, left buttons border radius: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_rl_btn_style">Right, left buttons style: </label></td>
                  <td>
                    <select name="carousel_rl_btn_style" id="carousel_rl_btn_style">
                      <?php
                      foreach ($button_styles as $key => $button_style) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->carousel_rl_btn_style == $key) ? 'selected="selected"' : ''); ?>><?php echo $button_style; ?></option>
                        <?php
                      }
                      ?>
                    </select>
          ...
          <fieldset class="spider_child_fieldset" id="Carousel_2">
            <table style="clear:both;">
              <tbody>
               ...
               <tr>
                  <td class="spider_label"><label for="carousel_mergin_bottom">Carousel margin: </label></td>
                  <td>
                 ...
                 <tr>
                  <td class="spider_label"><label for="carousel_feature_border_width">Image border width: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_feature_border_style">Image border style: </label>
                  </td>
                  <td>
                    <select name="carousel_feature_border_style" id="carousel_feature_border_style">
                      ...
                      foreach ($border_styles as $key => $border_style) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->carousel_feature_border_style == $key) ? 'selected="selected"' : ''); ?>><?php echo $border_style; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                 ...
                 <tr>
                  <td class="spider_label"><label for="carousel_feature_border_color">Image border color: </label></td>
                  <td>
          ...
          <fieldset class="spider_child_fieldset" id="Carousel_3">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="carousel_caption_background_color">Title background color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_title_opacity"> Title opacity: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_title_border_radius">Title border radius: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_caption_p_mergin">Title margin: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_caption_p_pedding">Title padding: </label></td>
                  <td>
                ...
                <tr>
                 <tr>
                  <td class="spider_label"><label for="carousel_font_family">Title Font family: </label></td>
                  <td>
                  ...
                  <td class="spider_label"><label for="carousel_caption_p_font_size">Title font size: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_caption_p_color">Title color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="carousel_caption_p_font_weight">Title font weight: </label></td>
                  <td>
                    <select name="carousel_caption_p_font_weight" id="carousel_caption_p_font_weight">
                      <?php
                      foreach ($font_weights as $key => $font_weight) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->carousel_caption_p_font_weight == $key) ? 'selected="selected"' : ''); ?>><?php echo $font_weight; ?></option>
                        <?php
                      }
                      ?>
                    </select>
