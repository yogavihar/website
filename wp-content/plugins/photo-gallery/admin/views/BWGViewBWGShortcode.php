        ...
        ?>
              <div style="text-align:center; height:85px;">
                ...
                <span class="gallery_type" onClick="bwg_gallery_type('blog_style')">
                  ...
                  <div style="text-align: center;"><input type="radio" id="carousel" name="gallery_type" value="carousel" /><label for="carousel">Carousel</label></div>
                  <label for="carousel"><img src="<?php echo WD_BWG_URL . '/images/Carousel.png'; ?>" /></label>
                </span>
              </div>
              <hr />
                ...
                <tbody>
                 ...
                 <!--Thumbnails, Masonry and Mosaic viewies-->
                  ...
                  <tr id="tr_compuct_album_enable_page">
                    <td class="spider_label"><label>Enable pagination: </label></td>
                    <td>
                      <input type="radio" name="compuct_album_enable_page" id="compuct_album_page_yes" value="1" <?php echo ($option_row->album_enable_page == '1') ? 'checked' : ''; ?> /><label for="compuct_album_page_yes">Yes</label>
                      <input type="radio" name="compuct_album_enable_page" id="compuct_album_page_no" value="0" <?php echo ($option_row->album_enable_page == '0') ? 'checked' : ''; ?> /><label for="compuct_album_page_no">No</label>  
                  ...
                  <tr id="tr_masonry_album_enable_page">
                    <td class="spider_label"><label>Enable pagination: </label></td>
                    <td>
                      <input type="radio" name="masonry_album_enable_page" id="masonry_album_page_yes" value="1" <?php echo ($option_row->album_enable_page == '1') ? 'checked' : ''; ?> /><label for="masonry_album_page_yes">Yes</label>
                      <input type="radio" name="masonry_album_enable_page" id="masonry_album_page_no" value="0" <?php echo ($option_row->album_enable_page == '0') ? 'checked' : ''; ?> /><label for="masonry_album_page_no">No</label>
                      <input type="radio" name="masonry_album_enable_page" id="masonry_album_page_loadmore" value="2" <?php echo ($option_row->album_enable_page == '2') ? 'checked' : ''; ?> /><label for="masonry_album_page_loadmore">Load More</label>
                      <input type="radio" name="masonry_album_enable_page" id="masonry_album_page_scrol_load" value="3" <?php echo ($option_row->album_enable_page == '3') ? 'checked' : ''; ?> /><label for="masonry_album_page_scrol_load">Scroll Load</label>
                    </td>
                  </tr>
                  ...
                  <tr id="tr_carousel_image_column_number">
                    <td class="spider_label"><label for="carousel_image_column_number"> Max. number of carousel images: </label></td>
                    <td><input type="text" name="carousel_image_column_number" id="carousel_image_column_number" value="<?php echo $option_row->carousel_image_column_number; ?>" class="spider_int_input" /></td>
                  </tr>
                </tbody>
              </table>
              </div>
              ...
              <table>
                ...
                <tr id="tr_carousel_width_height">
                    <td title="Maximum values for carousel width and height." class="spider_label"><label for="carousel_width">Carousel dimensions: </label></td>
                    <td>
                      <input type="text" name="carousel_width" id="carousel_width" value="<?php echo $option_row->carousel_width; ?>" class="spider_int_input" /> x 
                      <input type="text" name="carousel_height" id="carousel_height" value="<?php echo $option_row->carousel_height; ?>" class="spider_int_input" /> px
                    </td>
                  </tr>
                  <tr id="tr_carousel_image_par">
                    <td class="spider_label"><label for="carousel_image_par">Carousel image ratio:</label></td>
                    ...
                    <td class="spider_label"><label>Enable Autoplay: </label></td>
                    <td>
                      <input type="radio" name="enable_carousel_autoplay" id="carousel_autoplay_yes" value="1" <?php echo ($option_row->carousel_enable_autoplay) ? 'checked' : ''; ?> /><label for="carousel_autoplay_yes">Yes</label>
                      <input type="radio" name="enable_carousel_autoplay" id="carousel_autoplay_no" value="0" <?php echo ($option_row->carousel_enable_autoplay) ? '' : 'checked'; ?> /><label for="carousel_autoplay_no">No</label>
                    </td>
                  </tr>
                  <tr id="tr_carousel_interval">
                    <td title="Interval between two images." class="spider_label"><label for="carousel_interval">Time interval: </label></td>
                    <td><input type="text" name="carousel_interval" id="carousel_interval" value="<?php echo $option_row->carousel_interval; ?>" class="spider_int_input" /> sec.</td>
                  </tr>
                  <tr id="tr_enable_carousel_title">
                    <td class="spider_label"><label>Enable Image Title: </label></td>
                    <td>
                      <input type="radio" name="enable_carousel_title" id="carousel_title_yes" value="1" <?php echo ($option_row->carousel_enable_title) ? 'checked' : ''; ?> onClick="bwg_enable_disable('', 'tr_carousel_title_position', 'carousel_title_yes')" /><label for="carousel_title_yes">Yes</label>
                      <input type="radio" name="enable_carousel_title" id="carousel_title_no" value="0" <?php echo ($option_row->carousel_enable_title) ? '' : 'checked'; ?> onClick="bwg_enable_disable('none', 'tr_carousel_title_position', 'carousel_title_no')" /><label for="carousel_title_no">No</label>
                    </td>
                  </tr>
                  <tr id="tr_carousel_r_width">
                    <td title="Maximum values for carousel width and height." class="spider_label"><label for="carousel_r_width">Fixed width:</label></td>
                    <td>
                      <input type="text" name="carousel_r_width" id="carousel_r_width" value="<?php echo $option_row->carousel_r_width; ?>" class="spider_int_input" /> px 
                    ...
                    <td>
                      <input type="radio" name="carousel_fit_containerWidth" id="carousel_fit_containerWidth_yes" value="1" <?php echo ($option_row->carousel_fit_containerWidth) ? 'checked' : ''; ?> /><label for="carousel_fit_containerWidth_yes">Yes</label>
                      <input type="radio" name="carousel_fit_containerWidth" id="carousel_fit_containerWidth_no" value="0" <?php echo ($option_row->carousel_fit_containerWidth) ? '' : 'checked'; ?> /><label for="carousel_fit_containerWidth_no">No</label>
                    </td>
                  </tr> 
                  <tr id="tr_carousel_prev_next_butt">
                    <td class="spider_label"><label>Next/Previous buttons: </label></td>
                    <td>
                      <input type="radio" name="carousel_prev_next_butt" id="carousel_prev_next_butt_yes" value="1" <?php echo ($option_row->carousel_prev_next_butt) ? 'checked' : ''; ?> /><label for="carousel_prev_next_butt_yes">Yes</label>
                      <input type="radio" name="carousel_prev_next_butt" id="carousel_prev_next_butt_no" value="0" <?php echo ($option_row->carousel_prev_next_butt) ? '' : 'checked'; ?> /><label for="carousel_prev_next_butt_no">No</label>
                    </td>
                  </tr>
                  <tr id="tr_carousel_play_pause_butt">
                    <td class="spider_label"><label>Play/Pause button: </label></td>
                    <td>
                      <input type="radio" name="carousel_play_pause_butt" id="carousel_play_pause_butt_yes" value="1" <?php echo ($option_row->carousel_play_pause_butt) ? 'checked' : ''; ?> /><label for="carousel_play_pause_butt_yes">Yes</label>
                      <input type="radio" name="carousel_play_pause_butt" id="carousel_play_pause_butt_no" value="0" <?php echo ($option_row->carousel_play_pause_butt) ? '' : 'checked'; ?> /><label for="carousel_play_pause_butt_no">No</label>
                    </td>
                  </tr>
                <!--Lightbox view-->
