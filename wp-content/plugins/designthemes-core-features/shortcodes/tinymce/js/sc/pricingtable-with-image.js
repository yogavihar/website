		...
		for ( var h in c) {
			...
			if (d.length > 0) {
				...
				g += "<br>[dt_sc_"
						+ e
						+ "] "
						+ "<br>[dt_sc_pricing_table_item title='DesignThemes' thumb='http://placehold.it/300x200&text=DesignThemes' variation='"+variation+"' heading='gift'  button_text='Buy Now' button_link='#' currency='$' price1='15' price2='.85' "
