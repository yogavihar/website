...
class ehough_stash_Pool implements ehough_stash_interfaces_PoolInterface
{
    ...
    public function setItemClass($class)
    {
        ...
        if(!in_array('ehough_stash_interfaces_ItemInterface', $interfaces))
            throw new InvalidArgumentException('Item class ' . $class . ' must inherit from ehough_stash_interfaces_ItemInterface');
    ...
    public function getItem()
    {
        ...
        /** @var ehough_stash_interfaces_ItemInterface $item */
