...
/**
 * ehough_stash_Session lets developers use Stash's ehough_stash_Pool class to back session storage.
...
class ehough_stash_Session implements ehough_stash_session_SessionHandlerInterface
{
     ...
     * libraries.
     *
     * @param ehough_stash_interfaces_PoolInterface|ehough_stash_Pool $pool
     */
